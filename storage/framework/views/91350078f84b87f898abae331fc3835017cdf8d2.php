...
<div class="full-width">
      ...
      <div class="container other-side women">
        <div class="menu-area"> <?php echo e($cats->where('id',$id)->first()->name); ?>

        </div>
        <div class="col-md-2">
          <div class="left-sidebar">
            <div class="left-sidebar-tit">
              <span class="menu-name"><?php echo e($cats->where('id',$id)->first()->name); ?></span>
            </div>
            <div class="left-sidebar-body">
              <ul>
                <?php $__currentLoopData = $tags->where('category_id',$id); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tag): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
