                  ...
                  <div id="deletemyModal<?php echo e($item->id); ?>" class="modal fade" role="dialog">
                    <div class="modal-dialog">
                      ...
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <a href="<?php echo e(url('admin/tag/remove/'.$item->id )); ?>"><button type="submit" class="btn btn-sm btn-danger">Delete</button></a>
                    ...
                    <div class="modal-dialog">
                      ...
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          ...
                          <form role="form" method="POST" action="<?php echo e(url('admin/update_tag')); ?>">
                            <?php echo e(csrf_field()); ?>
