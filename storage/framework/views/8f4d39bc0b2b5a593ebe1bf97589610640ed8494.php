          ...
          <div id="carousel" class="carousel slide carousel-fade" data-ride="carousel">
            ...
            <div class="carousel-inner" role="listbox">
              <div class="item active">
                <a href="">
                  <img src="<?php echo e(url('images/slider/edited/slide1.png')); ?>" alt="siliconstore" width="460" height="345">
                </a>
              </div>

              <div class="item">
                <a href="">
                <img src="<?php echo e(url('images/slider/edited/slide2.jpg')); ?>" alt="siliconstore" width="460" height="345">
                </a>
              </div>
      ...
      <div class="container other-side item-blue">
        ...
        <div class="col-md-2">
          <div class="left-sidebar">
            ...
            <div class="left-sidebar-body">
              <ul>
                <?php $__currentLoopData = $tags->where('category_id',9); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tag): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <li><a href="<?php echo e(url('product/tag/'.$tag->id)); ?>"> <?php echo e($tag->name); ?></a></li>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
              </ul>
            </div>
            ...
            <div class="col-md-10 product-list">
              <div id="carouselph" class="carousel slide carousel-fade" data-ride="carousel">
                ...
                <div class="carousel-inner" role="listbox">
                  <div class="item active">
                    <?php $__currentLoopData = App\Items::where('category_id',9)->where('tag_id',16)->orderBy('created_at','desc')->paginate(4); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <div class="col-sm-3">
                        <div class="product">
                          <img src="<?php echo e(url('images/products/'.$item->photo)); ?>" alt="siliconstore">
                          <div class="item-sub">
                            <h3><a href="<?php echo e(url('product-detail/'.$item->id)); ?>"><?php echo e($item->product_name); ?></a></h3>
                            <p><?php echo str_limit($item->description, $limit = 30, $end = '....... '); ?></p>
                            <p><a href=""><?php echo e($cats->where('id',9)->first()->name); ?></a><span class="pull-right">₦<?php echo e($item->price); ?> </span></p>
                            <div>
                              <a href="<?php echo e(url('add_cart/'.$item->id)); ?>"><button class="addtocart">ADD TO CART</button></a>
                            </div> 
                          </div>
                  ...
                  <div class="item">
                    <?php $__currentLoopData = App\Items::where('category_id',9)->where('tag_id',17)->orderBy('created_at','desc')->paginate(4); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <div class="col-sm-3">
                        <div class="product">
                          <img src="<?php echo e(url('images/products/'.$item->photo)); ?>" alt="siliconstore">
                          <div class="item-sub">
                  ...
                  <div class="item">
                    <?php $__currentLoopData = App\Items::where('category_id',9)->where('tag_id',18)->orderBy('created_at','desc')->paginate(4); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <div class="col-sm-3">
                        <div class="product">
                          <img src="<?php echo e(url('images/products/'.$item->photo)); ?>" alt="siliconstore">
                          <div class="item-sub">
                  ...
                  <div class="item">
                    <?php $__currentLoopData = App\Items::where('category_id',9)->where('tag_id',19)->orderBy('created_at','desc')->paginate(4); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <div class="col-sm-3">
                        <div class="product">
                          <img src="<?php echo e(url('images/products/'.$item->photo)); ?>" alt="siliconstore">
                          <div class="item-sub">
      ...
      <div class="container other-side item-light-blue">
        ...
        <div class="col-md-2">
          <div class="left-sidebar">
            ...
            <div class="left-sidebar-body">
              <ul>
                <?php $__currentLoopData = $tags->where('category_id',10); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tag): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <li><a href="<?php echo e(url('product/tag/'.$tag->id)); ?>"> <?php echo e($tag->name); ?></a></li>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
              </ul>
            </div>
            ...
            <div class="col-md-10 product-list">
              <div id="carouselcm" class="carousel slide carousel-fade" data-ride="carousel">
               ...
               <div class="carousel-inner" role="listbox">
                  <div class="item active">
                    <?php $__currentLoopData = App\Items::where('category_id',10)->where('tag_id',26)->orderBy('created_at','desc')->paginate(4); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <div class="col-sm-3">
                        <div class="product">
                          <img src="<?php echo e(url('images/products/'.$item->photo)); ?>" alt="siliconstore">
                          <div class="item-sub">
                            <h3><a href="<?php echo e(url('product-detail/'.$item->id)); ?>"><?php echo e($item->product_name); ?></a></h3>
                            <p><?php echo str_limit($item->description, $limit = 30, $end = '....... '); ?></p>
                            <p><a href=""><?php echo e($cats->where('id',10)->first()->name); ?></a><span class="pull-right">₦<?php echo e($item->price); ?> </span></p>
                            <div>
                              <a href="<?php echo e(url('add_cart/'.$item->id)); ?>"><button class="addtocart">ADD TO CART</button></a>
                            </div> 
                          </div>
                  ...
                  <div class="item">
                    <?php $__currentLoopData = App\Items::where('category_id',10)->where('tag_id',27)->orderBy('created_at','desc')->paginate(4); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <div class="col-sm-3">
                        <div class="product">
                          <img src="<?php echo e(url('images/products/'.$item->photo)); ?>" alt="siliconstore">
                          <div class="item-sub">
                  ...
                  <div class="item">
                    <?php $__currentLoopData = App\Items::where('category_id',10)->where('tag_id',28)->orderBy('created_at','desc')->paginate(4); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <div class="col-sm-3">
                        <div class="product">
                          <img src="<?php echo e(url('images/products/'.$item->photo)); ?>" alt="siliconstore">
                          <div class="item-sub">
                  ...
                  <div class="item">
                    <?php $__currentLoopData = App\Items::where('category_id',10)->where('tag_id',32)->orderBy('created_at','desc')->paginate(4); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <div class="col-sm-3">
                        <div class="product">
                          <img src="<?php echo e(url('images/products/'.$item->photo)); ?>" alt="siliconstore">
                          <div class="item-sub">
      ...
      <div class="container other-side item-purple">
        ...
        <div class="col-md-2">
          <div class="left-sidebar">
            ...
            <div class="left-sidebar-body">
              <ul>
                <?php $__currentLoopData = $tags->where('category_id',11); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tag): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <li><a href="<?php echo e(url('product/tag/'.$tag->id)); ?>"> <?php echo e($tag->name); ?></a></li>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
              </ul>
            </div>
            ...
            <div class="col-md-10 product-list">
              <div id="carouselelect" class="carousel slide carousel-fade" data-ride="carousel">
                ...
                <div class="carousel-inner" role="listbox">
                  <div class="item active">
                    <?php $__currentLoopData = App\Items::where('category_id',11)->where('tag_id',22)->orderBy('created_at','desc')->paginate(4); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <div class="col-sm-3">
                        <div class="product">
                          <img src="<?php echo e(url('images/products/'.$item->photo)); ?>" alt="siliconstore">
                          <div class="item-sub">
                            <h3><a href="<?php echo e(url('product-detail/'.$item->id)); ?>"><?php echo e($item->product_name); ?></a></h3>
                            <p><?php echo str_limit($item->description, $limit = 30, $end = '....... '); ?></p>
                            <p><a href=""><?php echo e($cats->where('id',11)->first()->name); ?></a><span class="pull-right">₦<?php echo e($item->price); ?> </span></p>
                            <div>
                              <a href="<?php echo e(url('add_cart/'.$item->id)); ?>"><button class="addtocart">ADD TO CART</button></a>
                            </div> 
                          </div>
                  ...
                  <div class="item">
                    <?php $__currentLoopData = App\Items::where('category_id',11)->where('tag_id',23)->orderBy('created_at','desc')->paginate(4); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <div class="col-sm-3">
                        <div class="product">
                          <img src="<?php echo e(url('images/products/'.$item->photo)); ?>" alt="siliconstore">
                          <div class="item-sub">
                  ...
                  <div class="item">
                    <?php $__currentLoopData = App\Items::where('category_id',11)->where('tag_id',24)->orderBy('created_at','desc')->paginate(4); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <div class="col-sm-3">
                        <div class="product">
                          <img src="<?php echo e(url('images/products/'.$item->photo)); ?>" alt="siliconstore">
                          <div class="item-sub">
                  ...
                  <div class="item">
                    <?php $__currentLoopData = App\Items::where('category_id',11)->where('tag_id',25)->orderBy('created_at','desc')->paginate(4); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <div class="col-sm-3">
                        <div class="product">
                          <img src="<?php echo e(url('images/products/'.$item->photo)); ?>" alt="siliconstore">
                          <div class="item-sub">
