          ...
          <div id="carousel" class="carousel slide carousel-fade" data-ride="carousel">
            ...
            <div class="carousel-inner" role="listbox">
              <div class="item active">
                <a href="">
                  <img src="{{ url('images/slider/edited/slide1.png') }}" alt="boomstore" width="460" height="345">
                </a>
              </div>

              <div class="item">
                <a href="">
                <img src="{{ url('images/slider/edited/slide2.jpg') }}" alt="boomstore" width="460" height="345">
                </a>
              </div>
        ...
        <div class="col-md-3 right-scroll">
          ...
          <div id="random-pro" class="carousel slide carousel-fade" data-ride="carousel">
            ...
            <div class="carousel-inner" role="listbox">
              <div class="item active">
                ...
                <div class="random-items">
                  <div class="col-xs-4 random-left">
                    <img src="{{ url('images/products/'.$item->photo) }}" alt="boomstore">
                  </div>
                  <div class="col-xs-8">
              ...
              <div class="item">
                @foreach(App\Items::where('category_id',3)->orderBy('created_at','desc')->paginate(3) as $item)
                <div class="random-items">
                  <div class="col-xs-4 random-left">
                    <img src="{{ url('images/products/'.$item->photo) }}" alt="boomstore">
                  </div>
              ...
              <div class="item">
                @foreach(App\Items::where('category_id',4)->orderBy('created_at','desc')->paginate(3) as $item)
                <div class="random-items">
                  <div class="col-xs-4 random-left">
                    <img src="{{ url('images/products/'.$item->photo) }}" alt="boomstore">
                  </div>
              ...
              <div class="item">
                @foreach(App\Items::where('category_id',5)->orderBy('created_at','desc')->paginate(3) as $item)
                <div class="random-items">
                  <div class="col-xs-4 random-left">
                    <img src="{{ url('images/products/'.$item->photo) }}" alt="boomstore">
                  </div>
      ...
      <div class="container other-side item-blue">
        ...
        <div class="col-md-2">
          <div class="left-sidebar">
            ...
            <div class="left-sidebar-body">
              <ul>
                @foreach($tags->where('category_id',3) as $tag)
                <li><a href="{{ url('product/tag/'.$tag->id) }}"> {{ $tag->name }}</a></li>
                @endforeach
              </ul>
            </div>
            ...
            <div class="col-md-10 product-list">
              <div id="carouselph" class="carousel slide carousel-fade" data-ride="carousel">
                ...
                <div class="carousel-inner" role="listbox">
                  <div class="item active">
                    @foreach(App\Items::where('category_id',3)->where('tag_id',16)->orderBy('created_at','desc')->paginate(4) as $item)
                      <div class="col-sm-3">
                        <div class="product">
                          <img src="{{ url('images/products/'.$item->photo) }}" alt="boomstore">
                          <div class="item-sub">
                            <h3><a href="{{ url('product-detail/'.$item->id) }}">{{ $item->product_name }}</a></h3>
                            <p>{!! str_limit($item->description, $limit = 30, $end = '....... ') !!}</p>
                            <p><a href="">{{ $cats->where('id',3)->first()->name }}</a><span class="pull-right">₦{{ $item->price }} </span></p>
                            <div>
                              <a href="{{ url('add_cart/'.$item->id) }}"><button class="addtocart">ADD TO CART</button></a>
                            </div> 
                          </div>
                  ...
                  <div class="item">
                    @foreach(App\Items::where('category_id',3)->where('tag_id',17)->orderBy('created_at','desc')->paginate(4) as $item)
                      <div class="col-sm-3">
                        <div class="product">
                          <img src="{{ url('images/products/'.$item->photo) }}" alt="boomstore">
                          <div class="item-sub">
                  ...
                  <div class="item">
                    @foreach(App\Items::where('category_id',3)->where('tag_id',18)->orderBy('created_at','desc')->paginate(4) as $item)
                      <div class="col-sm-3">
                        <div class="product">
                          <img src="{{ url('images/products/'.$item->photo) }}" alt="boomstore">
                          <div class="item-sub">
                  ...
                  <div class="item">
                    @foreach(App\Items::where('category_id',3)->where('tag_id',19)->orderBy('created_at','desc')->paginate(4) as $item)
                      <div class="col-sm-3">
                        <div class="product">
                          <img src="{{ url('images/products/'.$item->photo) }}" alt="boomstore">
                          <div class="item-sub">
      ...
      <div class="container other-side item-light-blue">
        ...
        <div class="col-md-2">
          <div class="left-sidebar">
            ...
            <div class="left-sidebar-body">
              <ul>
                @foreach($tags->where('category_id',4) as $tag)
                <li><a href="{{ url('product/tag/'.$tag->id) }}"> {{ $tag->name }}</a></li>
                @endforeach
              </ul>
            </div>
            ...
            <div class="col-md-10 product-list">
              <div id="carouselcm" class="carousel slide carousel-fade" data-ride="carousel">
               ...
               <div class="carousel-inner" role="listbox">
                  <div class="item active">
                    @foreach(App\Items::where('category_id',4)->where('tag_id',26)->orderBy('created_at','desc')->paginate(4) as $item)
                      <div class="col-sm-3">
                        <div class="product">
                          <img src="{{ url('images/products/'.$item->photo) }}" alt="boomstore">
                          <div class="item-sub">
                            <h3><a href="{{ url('product-detail/'.$item->id) }}">{{ $item->product_name }}</a></h3>
                            <p>{!! str_limit($item->description, $limit = 30, $end = '....... ') !!}</p>
                            <p><a href="">{{ $cats->where('id',4)->first()->name }}</a><span class="pull-right">₦{{ $item->price }} </span></p>
                            <div>
                              <a href="{{ url('add_cart/'.$item->id) }}"><button class="addtocart">ADD TO CART</button></a>
                            </div> 
                          </div>
                  ...
                  <div class="item">
                    @foreach(App\Items::where('category_id',4)->where('tag_id',27)->orderBy('created_at','desc')->paginate(4) as $item)
                      <div class="col-sm-3">
                        <div class="product">
                          <img src="{{ url('images/products/'.$item->photo) }}" alt="boomstore">
                          <div class="item-sub">
                  ...
                  <div class="item">
                    @foreach(App\Items::where('category_id',4)->where('tag_id',28)->orderBy('created_at','desc')->paginate(4) as $item)
                      <div class="col-sm-3">
                        <div class="product">
                          <img src="{{ url('images/products/'.$item->photo) }}" alt="boomstore">
                          <div class="item-sub">
                  ...
                  <div class="item">
                    @foreach(App\Items::where('category_id',4)->where('tag_id',32)->orderBy('created_at','desc')->paginate(4) as $item)
                      <div class="col-sm-3">
                        <div class="product">
                          <img src="{{ url('images/products/'.$item->photo) }}" alt="boomstore">
                          <div class="item-sub">
      ...
      <div class="container other-side item-purple">
        ...
        <div class="col-md-2">
          <div class="left-sidebar">
            ...
            <div class="left-sidebar-body">
              <ul>
                @foreach($tags->where('category_id',5) as $tag)
                <li><a href="{{ url('product/tag/'.$tag->id) }}"> {{ $tag->name }}</a></li>
                @endforeach
              </ul>
            </div>
            ...
            <div class="col-md-10 product-list">
              <div id="carouselelect" class="carousel slide carousel-fade" data-ride="carousel">
                ...
                <div class="carousel-inner" role="listbox">
                  <div class="item active">
                    @foreach(App\Items::where('category_id',5)->where('tag_id',22)->orderBy('created_at','desc')->paginate(4) as $item)
                      <div class="col-sm-3">
                        <div class="product">
                          <img src="{{ url('images/products/'.$item->photo) }}" alt="boomstore">
                          <div class="item-sub">
                            <h3><a href="{{ url('product-detail/'.$item->id) }}">{{ $item->product_name }}</a></h3>
                            <p>{!! str_limit($item->description, $limit = 30, $end = '....... ') !!}</p>
                            <p><a href="">{{ $cats->where('id',5)->first()->name }}</a><span class="pull-right">₦{{ $item->price }} </span></p>
                            <div>
                              <a href="{{ url('add_cart/'.$item->id) }}"><button class="addtocart">ADD TO CART</button></a>
                            </div> 
                          </div>
                  ...
                  <div class="item">
                    @foreach(App\Items::where('category_id',5)->where('tag_id',23)->orderBy('created_at','desc')->paginate(4) as $item)
                      <div class="col-sm-3">
                        <div class="product">
                          <img src="{{ url('images/products/'.$item->photo) }}" alt="boomstore">
                          <div class="item-sub">
                  ...
                  <div class="item">
                    @foreach(App\Items::where('category_id',5)->where('tag_id',24)->orderBy('created_at','desc')->paginate(4) as $item)
                      <div class="col-sm-3">
                        <div class="product">
                          <img src="{{ url('images/products/'.$item->photo) }}" alt="boomstore">
                          <div class="item-sub">
                  ...
                  <div class="item">
                    @foreach(App\Items::where('category_id',5)->where('tag_id',25)->orderBy('created_at','desc')->paginate(4) as $item)
                      <div class="col-sm-3">
                        <div class="product">
                          <img src="{{ url('images/products/'.$item->photo) }}" alt="boomstore">
                          <div class="item-sub">
