...
<div class="full-width">
      ...
      <div class="container other-side women">
        <div class="menu-area"> {{ $tags->where('id',$id)->first()->name }}
        </div>
        <div class="col-md-2">
          <div class="left-sidebar">
            <div class="left-sidebar-tit">
              <span class="menu-name">{{ $tags->where('id',$id)->first()->name }}</span>
            </div>
            <div class="left-sidebar-body">
              <ul>
                @foreach($tags->where('category_id',$tags->where('id',$id)->first()->category_id) as $tag)
                ...
                <div class="col-sm-3">
                  <div class="product">
                    ...
                    <div class="item-sub">
                      ...
                      <p><a href="">{{ $tags->where('id',$id)->first()->name }}</a><span class="pull-right">₦{{ $g->price }} </span></p>
                      <div>
