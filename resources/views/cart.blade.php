      ...
      <div class="bread-crumb"><a href="">Home</a> / <span class="curr"> Cart </span>
        ...
        <div class="col-md-9">
          ...
          <div class="col-md-7 check-out-side">
            ...
            <p><a href="{{ url('/') }}"><button class="btn btn-success col-sm-4">Continue Shopping</button></a>
               @if(isset($sum))<a href="{{ url('/check-out') }}"><button class="col-sm-4 btn btn-primary pull-right">Proceed to checkout</button></a>@endif
            </p>
