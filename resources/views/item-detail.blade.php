...
<div class="full-width">
    <div class="container main-page">
      <div class="bread-crumb"><a href="">Home</a> / <span class="curr"> {{ $getp->product_name }} </span>
      </div>
        <div class="col-md-9">
          <div class="col-md-4">
            <img src="{{ url('images/products/'.$getp->photo) }}" alt="boomstore" class="detail-img">
          </div>
          <div class="col-md-8">
            <h3>Product Name</h3>
            <p>{{ $getp->product_name }}</p>
            <h3>Description</h3>
            <p>{{ $getp->description }}</p>
            <h3>Price</h3>
            <p>₦{{ $getp->price }}</p>
            <div class="cart-below">
              <a href="{{ url('add_cart/'.$getp->id) }}"><button class="addtocart">ADD TO CART</button></a>
            </div> 
          </div>
        </div>
