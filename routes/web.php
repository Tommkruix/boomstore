...
Route::get('/add_cart/{id}', 'BoomController@add_cart');
Route::get('/cart/remove/{id}', 'BoomController@remove_cart');
Route::get('/empty-cart', 'BoomController@empty_cart');
Route::get('/cart', 'BoomController@cart_items');
Route::post('/update-cart', 'BoomController@update_cart');
Route::get('/product-detail/{id}', 'BoomController@product_detail');
Route::get('/product/tag/{id}', 'BoomController@product_tag');
Route::get('/product/category/{id}', 'BoomController@product_category');
...
Route::post('/search', 'BoomController@search_item');
Route::get('/search-result/{dt}', 'BoomController@search_result');
